...
// RESEND_API_KEY loaded after loadEnv()
...
I came across ${target.business} while building out our directory. Hosts in ${target.hub.replace(" PA", "")} are always looking for reliable help, and I wanted to make sure you show up when they search.
...
async function main() {
  ...
  console.log(`Targets: ${filtered.length} (of ${withEmail.length} with email)\n`);
