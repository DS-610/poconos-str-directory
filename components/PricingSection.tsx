...
const ONE_TIME_PRODUCTS = [
  ...
  },
  {
    ...
    price: "$99",
    description: "One-time fee for the Verified STR Pro badge. Shows hosts you are licensed, insured, and vetted.",
    features: [
    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
            ...
            >
              ...
              {billing === "monthly" && (
                <p className="mt-1 text-xs text-stone-400">
                  or {plan.annual}/year ({plan.annualSave})
                </p>
              )}
      ...
      <div className="mt-20">
        ...
        <p className="mt-6 text-center text-xs text-stone-500">
          Payments via Stripe · Cancel anytime · Annual plans save 2 months
        </p>
      </div>
    </div>
  );
